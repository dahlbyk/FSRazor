...
let githubLink = "http://github.com/dahlbyk/FSRazor"

// Specify more information about your project
let info =
  [ "project-name", "FSRazor"
    "project-author", "Update Author in build.fsx"
    "project-summary", "F# Parser and Code Generator for Razor View Engine"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/FSRazor" ]
